...
<center><h2>Invoices & Donations Payments Details Recieved Via Invoices API</h2></center>
...
alert('Inoice');
          ...
          form_data.append('invoice', invoice);
                    ...
                    $('#loader_p').fadeIn(400).html('<br><span class="well" style="color:black"><img src="ajax-loader.gif">&nbsp;Please Wait,fetching Invoice  Details From Square API...</span>');
                    $.ajax({
                        url: 'list_invoice.php',
                        data: form_data,
                        processData: false,
                        contentType: false,
                        ache: false,
